...
-- Contains type level information about the algorithm used. 
--
...
--
-- Adding the type family @(AlgNm nm)@ restriction to @Encoding@ constructor slows down the compilation.  
